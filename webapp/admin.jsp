...
String title = "", username = "", remark = null;
...
<html lang="zh-cn">
  ...
  <body>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body editStudentModal">
            <table class="editTable">
              ...
              <tr style="height:3em;"><td>辅导员：</td><td><input type="text" class="form-control" id="editComment" disabled="disabled"></td></tr>
            </table>
          </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="moveWait" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body editStudentModal">
            <table class="editTable">
              ...
              <tr style="height:3em;"><td>辅导员：</td><td><input type="text" class="form-control" id="addComment"></td></tr>
            </table>
          </div>
          <div class="modal-footer">
    ...
    <div class="modal fade" id="move" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            <h4 class="modal-title" id="moveTitle">移动学生</h4>
          </div>
          <div class="modal-body editStudentModal">
            <div id="moveTree"></div>
          </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="mailHistory" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            <h4 class="modal-title" id="myModalLabel">邮件发送记录</h4>
          </div>
          <div class="modal-body editStudentModal">          
            <div style="max-height:60em; overflow:auto;">
            	<table style="width:95%; margin:1em auto;" class="formerComment table table-bordered">
              		<tr><td style="width:25%; text-align:center;">主题</td>
                  		...
                  		<td style="width:15%; text-align:center;">发送时间</td>
                  		
                  		
              		</tr>
              		<tbody id="mailListTable">
              		</tbody>
            	</table>
            </div>
          </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="msgHistory" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            <h4 class="modal-title" id="myModalLabel">短信发送记录</h4>
          </div>
          <div class="modal-body editStudentModal">          
            <div style="max-height:60em; overflow:auto;">
            	<table style="width:95%; margin:1em auto;" class="formerComment table table-bordered">
    ...
    <!-- Modal -->
    <div class="modal fade" id="tagCloud" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
          ...
          <div class="modal-body editStudentModal">          
            <div style="max-height:60em; overflow:auto;">
            	<table style="width:95%; margin:1em auto;" class="formerComment table table-bordered">
              		<tr><td style="width:25%; text-align:center;">编号</td>
              			<td style="width:25%; text-align:center;">标签</td>
                        <td style="width:25%; text-align:center;">统计</td>               		
              		</tr>
              		<tbody id="tagCloudTable">
              		</tbody>
            	</table>
            </div>
          </div>
      ...
      <div class="nav-side">
        ...
        <div class="hideTheDiv" id="optionSide" style="height:68%;">
          <div style="padding-top:7px;">
            <table>
              <tr><td style="padding-left:1em;"><button type="button" class="btn btn-default" onClick="deleteAll();">全删</button></td>
              	  <td style="width:2em; text-align:center;" id="totalSelected">0</td>
                  <td><button type="button" class="btn btn-default" onClick="clearSelected();">清空</button></td>
                  <td><button type="button" class="btn btn-default" data-toggle="modal" data-target="#commentStudentHis" onClick="commentStuAll();">评价</button></td>
                      ...
                      <div class="input-group-btn">
                        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">操作<span class="caret"></span></button>
                          <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a class="category" data-toggle="modal" data-target="#msg" onClick="cancleSend();">群发短信</a></li>                                                                          
                          </ul>
                      </div><!-- /btn-group -->
                      </td>                       
          ...
          <table class="search-area" style="width:100%">
            <tr><td><button type="button" class="btn btn-default" onClick="prePage();" id="pre">前页</button></td>
                ...
                <td style="width:10em;"><div class="input-group">
                      <div class="input-group-btn">
                        <button type="button" class="btn btn-default" id="eachPageNum">每页</button>                          
                      </div><!-- /btn-group -->                      
                ...
                <td><p style="padding-left:0.5em; padding-right:0.5em; height:1.2em; font-size:1.2em; margin:auto 0; width:6em;" id="showTotal">共0条</p></td>
                 <!--  
                ...
                <td>
                      <div class="input-group-btn">
                        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">更多<span class="caret"></span></button>
                          <ul class="dropdown-menu" role="menu">
                            <li><a class="category" data-toggle="modal" data-target="#mailHistory" onClick="mailHistory();">邮件发送记录</a></li>
                            <li><a class="category" data-toggle="modal" data-target="#msgHistory" onClick="msgHistory();">短信发送记录</a></li>
                            <li><a class="category" data-toggle="modal" data-target="#tagCloud" onClick="tagCloud();">标签云</a></li>                                                                          
                          </ul>
                      </div><!-- /btn-group -->
                      </td>
            ...
            <div class="modal-body editStudentModal">
              <table class="table-bordered" style="width:98%; margin:auto;">
                <tr><td style="width:10%; text-align:center;">用户名</td>
                    ...
                    <td style="width:20%; text-align:center;">电话</td>
                    <td style="width:40%; text-align:center;">邮箱</td>
                </tr>
                <tbody id="infoTable">
                </tbody>
                <tr>
                    ...
                    <td style="width:10%; text-align:center;"></td>
                    <td style="width:20%; text-align:center;"><button type="button" class="btn btn-default" onClick="changePsw();">修改</button></td>
                    <td style="width:20%; text-align:center;"><button type="button" class="btn btn-default" onClick="addPhone();">增加</button></td>
                    <td style="width:40%; text-align:center;"><button type="button" class="btn btn-default" onClick="addMail();">增加</button></td>
                </tr>
              </table>
            </div> 
            <div class="modal-footer">                      
      ...
      <div class="modal fade" id="msg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body editStudentModal">
              <div>
                <textarea class="form-control" rows="10" id="msg-content" onkeydown="countChar('msg-content','counter');" onkeyup="countChar('msg-content','counter');"></textarea>
              </div>
            </div> 
            <div class="modal-footer">
