...
function listStudentByTag(objs){
	...
	$.each(objs, function displayStudent(id,item){
		...
		var cell1=document.createElement ("td");	
		cell1.innerHTML = "<input type=\"checkbox\" name=\"student-list\" id=\"checkbox"+item.student.id+"\">";
		cell1.setAttribute("width","4%");
		newNode.appendChild (cell1);
		...
		cell12.innerHTML = "<input type=\"button\" class=\"btn btn-default btn-comment\" value=\"点击查看\" onClick=\"seeComment("+item.student.id+");\" id=\"csee"+item.student.id+"\">";
		...
		newNode1.id = "ctr" + item.student.id;
...
function initUploader(){
	...
	new AjaxUpload('uploader', {
		action : "/MessagePlatform/upload?oid="+oid,
		data : {},
		async: false, 
